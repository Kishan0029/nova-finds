...
export const metadata = {
  title: "Terms & Conditions | Nova Finds",
  description: "Read the rules, guidelines, and legal agreements governing the use of the Nova Finds platform and services.",
};

export default function TermsPage() {
  return (
    <PolicyLayout title="Terms & Conditions" lastUpdated="July 1, 2026">
      <div className="space-y-6 text-foreground/95">
        ...
        <p className="text-sm md:text-base leading-relaxed">
          This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <Link href="https://novafinds.gonextverse.in/" className="text-primary hover:underline font-medium">https://novafinds.gonextverse.in/</Link> (&apos;Website&apos;), including the related mobile site and mobile application (hereinafter referred to as &apos;Platform&apos;).
        </p>

        <p className="text-sm md:text-base leading-relaxed">
          The Platform is owned by <strong className="font-semibold text-foreground">Nova Finds</strong>, a company incorporated under the Companies Act, 1956 with its registered office at <strong className="font-semibold text-foreground">Shivam Plot No 9, New Shivaji Colony, Belgaum, Karnataka, India</strong> (hereinafter referred to as &apos;Platform Owner&apos;, &apos;we&apos;, &apos;us&apos;, &apos;our&apos;).
        </p>
        ...
        <div className="bg-primary/5 border-l-4 border-primary p-5 rounded-r-2xl my-6">
          <p className="text-sm font-medium text-foreground uppercase tracking-wider mb-2">Notice to Users</p>
        ...
        <h2 className="font-heading text-xl md:text-2xl font-bold text-foreground mt-8 mb-4">
        ...
        <ul className="list-decimal pl-6 space-y-4 text-sm md:text-base leading-relaxed">
          <li>
          ...
          <li>
            The contents of the Platform and the Services are proprietary to us and are licensed to us. You will not have any authority to claim any intellectual property rights, title, or interest in its contents. The contents include and are not limited to the design, layout, look, and graphics of the website.
          </li>
          <li>
          ...
          <li>
            All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in <strong className="font-semibold text-foreground">Belgaum, Karnataka, India</strong>.
          </li>
          <li>
            All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this Website (<Link href="/contact" className="text-primary hover:underline font-medium">support@novafinds.com</Link>).
          </li>
        </ul>
      </div>
    </PolicyLayout>
